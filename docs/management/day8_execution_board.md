...
| D8-04 | Full manual QA matrix | API_CORE_PASS_APPETIZE_AUTH_PETS_PASS | `temp/qa/day8-appetize-deep-login/day8-render-api-core-smoke.json`, `docs/qa/day8_manual_qa_accessibility_report.md` |
| D8-05 | Accessibility pass | PARTIAL_AUTH_PETS_PASS | `docs/qa/day8_manual_qa_accessibility_report.md`; no severe issue observed on exercised Appetize auth/pets surface |
...
- [ ] Full visual manual QA across every MVP screen has no P0/P1 core-flow bugs.
- [ ] Full screen-by-screen accessibility pass has no severe contrast/tap-target/text-scale issues.
